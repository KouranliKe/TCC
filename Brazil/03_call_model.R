...
# The reproducible forecasts should be obtained with the parallel mclapply()
# model_list = list()
# for(i in for_ind){
...
models_parallel <- mclapply(for_ind, function(i) {
  model = rolling_window(
    ...
    #,post=TRUE # uncomment for post-LASSO
    #,extra_trees = TRUE # uncomment for lightgbm-ert
    #,alpha=0.5 # uncomment for elastic net and adaeelasticnet, set to 0 for ridge regression
